      ...
      <div class="col-md">
        <div class="card mb-4 mb-md-0">
          <div class="card-body">
            ...
            <hr>
            <form action="hasil_form.php" method="post" onsubmit="return validateForm()">
              <div class="mb-3">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="kendaraan[]" value="Motor" id="motor">
                <label class="form-check-label" for="motor">Motor</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="kendaraan[]" value="Mobil" id="mobil">
              ...
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="telp" name="telp" placeholder="Nomor Telepon" pattern="[0-9]+" title="No Telepon hanya bisa menerima angka" required />
              </div>
              <div class="mb-3">
